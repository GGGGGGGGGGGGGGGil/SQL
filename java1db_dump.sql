...
CREATE TABLE IF NOT EXISTS `bank_account` (
  ...
  `a_item_dist` varchar(2) DEFAULT NULL,
  `a_item_name` varchar(10) DEFAULT NULL,
  `a_c_no` varchar(20) DEFAULT NULL,
...
INSERT INTO `bank_account` (`a_no`, `a_item_dist`, `a_item_name`, `a_c_no`, `a_balance`, `a_open_date`) VALUES
	...
	('101-12-1002', 'S2', '장기적립예금', '830513-2000003', 1020000, '2011-05-13'),
	('101-13-1005', 'S3', '주택청약예금', '941127-2000005', 720800, '2012-10-15'),
...
CREATE TABLE IF NOT EXISTS `bank_customer` (
  ...
  `c_dist` tinyint DEFAULT NULL,
  `c_phone` varchar(20) DEFAULT NULL,
  `c_addr` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`c_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `bank_customer` (`c_no`, `c_name`, `c_dist`, `c_phone`, `c_addr`) VALUES
	...
	('870830-1000004', '강감찬', 1, '010-1234-1004', '서울시 영동포구'),
...
CREATE TABLE IF NOT EXISTS `bank_transaction` (
  ...
  `t_a_no` varchar(20) DEFAULT NULL,
...
-- 테이블 데이터 java1_board.board_article:~33 rows (대략적) 내보내기
INSERT INTO `board_article` (`no`, `parent`, `comment`, `cate`, `title`, `content`, `file`, `hit`, `uid`, `regip`, `rdate`) VALUES
	(17, 0, 0, 'school', '귀', '1', 0, 9, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:32:22'),
	(18, 0, 0, 'school', '농', '2', 0, 0, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:32:25'),
	(19, 0, 0, 'school', '학', '3', 0, 2, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:32:29'),
	(20, 0, 0, 'school', '교', '4', 0, 2, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:32:32'),
	(21, 0, 0, 'school', '귁', '6', 0, 5, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:32:34'),
	(22, 0, 0, 'grow', '텃', '7', 0, 1, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:32:38'),
	(23, 0, 0, 'grow', '밭', '8', 0, 1, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:32:41'),
	(24, 0, 0, 'grow', '가', '9', 0, 5, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:32:43'),
	(25, 0, 0, 'grow', '꾸', '0', 0, 4, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:32:46'),
	(26, 0, 0, 'grow', '기', '11', 0, 6, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:32:49'),
	(27, 0, 0, 'story', '농', '12', 0, 2, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:32:51'),
	(28, 0, 0, 'story', '작', '13', 0, 9, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:32:54'),
	(29, 0, 0, 'story', '물', '작성', 0, 0, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:36:32'),
	(30, 0, 0, 'story', '이', '[Y]', 0, 0, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:39:35'),
	(31, 0, 0, 'story', '야기', '33333333', 0, 1, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:39:59'),
	(32, 0, 0, 'event', '이', '123123', 0, 0, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:43:27'),
	(33, 0, 0, 'event', '벤', 'rrrrrrrrrrrrrrrrrrrrrrrrrrRRRRRRRRRRRRRRRRRRRRRRR', 0, 0, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:45:32'),
	(34, 0, 0, 'event', '트', '5555555555555555555555555555555555555555', 0, 0, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:45:37'),
	(35, 0, 0, 'event', '쇼', '99999999999999999999999999999999', 0, 0, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:45:43'),
	(36, 0, 0, 'event', '임', '11', 0, 1, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:46:17'),
	(37, 0, 0, 'market', '마1', '22', 0, 0, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:46:20'),
	(38, 0, 0, 'market', '마2', '33', 0, 0, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:46:22'),
	(39, 0, 0, 'market', '마3', '44', 0, 0, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:46:27'),
	(40, 0, 0, 'market', '켓1', '111', 0, 0, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:50:03'),
	(41, 0, 0, 'notice', '공사', '222', 0, 0, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:50:06'),
	(42, 0, 0, 'notice', '공지', '333', 0, 5, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:50:09'),
	(43, 0, 0, 'notice', '사항', '444', 0, 2, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:50:12'),
	(55, 0, 0, 'qna', '자주', '실험용1', 0, 0, 'w101', '0:0:0:0:0:0:0:1', '2022-11-17 09:58:27'),
	(58, 0, 0, 'qna', '고객', '', 0, 0, 'q101', '0:0:0:0:0:0:0:1', '2022-11-03 11:25:12'),
	(59, 0, 0, 'qna', '문의', 'ffffffffffffffff', 0, 0, 'q101', '0:0:0:0:0:0:0:1', '2022-11-03 11:25:46'),
	(60, 0, 0, 'faq', '자주', '치킨, 햄버거, 피자, 돈까스, 소바, 타코야끼, 족발', 0, 0, 'w101', '0:0:0:0:0:0:0:1', '2022-11-16 11:50:30'),
	(61, 0, 0, 'faq', '묻는', '두리안, 코코넛, 사과, 양파, 가지, 오이, 배추', 0, 4, 'w101', '0:0:0:0:0:0:0:1', '2022-11-16 12:40:22'),
	(62, 0, 0, 'faq', '질문', '1', 0, 4, 'w101', '0:0:0:0:0:0:0:1', '2022-11-01 09:32:22');
...
-- 테이블 데이터 java1_board.board_file:~0 rows (대략적) 내보내기
...
-- 테이블 데이터 java1_board.board_terms:~0 rows (대략적) 내보내기
...
-- 테이블 데이터 java1_board.board_user:~4 rows (대략적) 내보내기
INSERT INTO `board_user` (`uid`, `pass`, `name`, `nick`, `email`, `hp`, `grade`, `zip`, `addr1`, `addr2`, `regip`, `rdate`) VALUES
	('c101', '67a74ed8f1c615dffa61c3dcfd3e781151f6f38e83c3a29b1aee52ff3ea4204d', '캐서디', '맥', 'uuuu5555@gmail.com', '010-8888-7777', 2, '', '', '', '0:0:0:0:0:0:0:1', '2022-11-21 10:59:08'),
	('q101', '77d8ad705635306e91eef0f97b28045ff7533ea4e8a60eb19f305e873f39f41f', '나립', 'sdaf', 'kkkk603011@naver.com', '010-1234-8887', 2, '05315', '서울 강동구 양재대로123길 7', '', '0:0:0:0:0:0:0:1', '2022-10-31 09:07:48'),
	('r101', '2611d1679dbf6286218fb6025c8c52188f9492ca104158a0fee161a0822a7402', '길은섭', '아아', 'javapext@gmail.com', '010-5357-2938', 2, '47874', '부산 동래구 종합운동장로 29', '100000층', '0:0:0:0:0:0:0:1', '2022-11-22 13:58:39'),
	('w101', '2611d1679dbf6286218fb6025c8c52188f9492ca104158a0fee161a0822a7402', '남세라', '세라', 'kkkk60301@naver.com', '010-4444-4444', 2, '46300', '부산 금정구 온천장로 129', '100층', '0:0:0:0:0:0:0:1', '2022-10-31 13:16:48');
...
-- 테이블 데이터 java1_bookstore.book:~4 rows (대략적) 내보내기
INSERT INTO `book` (`bookId`, `bookName`, `publisher`, `price`) VALUES
	(1, '축구의 역사', '굿스포츠', 7000),
	(2, '축구의이해', '대한미디어', 22000),
	(3, '골프바이블', '대한미디어', 35000),
	(4, '게임의 역사', 'T1', 30000),
	(6, '정보처리기사', '대한미디어', 55555);
...
-- 테이블 데이터 java1_bookstore.customer:~5 rows (대략적) 내보내기
...
-- 테이블 데이터 java1_college.lecture:~1 rows (대략적) 내보내기
...
-- 테이블 데이터 java1_college.student:~1 rows (대략적) 내보내기
INSERT INTO `student` (`stdNo`, `stdName`, `stdHp`, `stdyear`, `stdAddress`) VALUES
	('20201016', '김유신', '010-1234-1001', 3, '김해시');
...
-- java1_md_bookstore 데이터베이스 구조 내보내기
DROP DATABASE IF EXISTS `java1_md_bookstore`;
CREATE DATABASE IF NOT EXISTS `java1_md_bookstore` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `java1_md_bookstore`;

-- 테이블 java1_md_bookstore.book 구조 내보내기
DROP TABLE IF EXISTS `book`;
CREATE TABLE IF NOT EXISTS `book` (
  ...
  CONSTRAINT `fk_Book_Publisher1` FOREIGN KEY (`pubName`) REFERENCES `publisher` (`pubName`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 java1_md_bookstore.book:~0 rows (대략적) 내보내기

-- 테이블 java1_md_bookstore.customer 구조 내보내기
DROP TABLE IF EXISTS `customer`;
CREATE TABLE IF NOT EXISTS `customer` (
  `custId` int NOT NULL AUTO_INCREMENT,
  `custName` varchar(45) NOT NULL,
  `custHp` char(13) NOT NULL,
  `custAddr` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`custId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 java1_md_bookstore.customer:~0 rows (대략적) 내보내기

-- 테이블 java1_md_bookstore.order 구조 내보내기
DROP TABLE IF EXISTS `order`;
CREATE TABLE IF NOT EXISTS `order` (
  `orderId` int NOT NULL AUTO_INCREMENT,
  `salePrice` int NOT NULL,
...
-- 테이블 데이터 java1_md_bookstore.order:~0 rows (대략적) 내보내기

-- 테이블 java1_md_bookstore.publisher 구조 내보내기
DROP TABLE IF EXISTS `publisher`;
CREATE TABLE IF NOT EXISTS `publisher` (
  `pubName` varchar(45) NOT NULL,
  `pubManager` varchar(45) NOT NULL,
  `pubTel` varchar(45) NOT NULL,
  PRIMARY KEY (`pubName`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 java1_md_bookstore.publisher:~0 rows (대략적) 내보내기
...
-- 테이블 데이터 java1_shop.customer:~8 rows (대략적) 내보내기
INSERT INTO `customer` (`custId`, `name`, `hp`, `addr`, `rdate`) VALUES
	...
	('c108', '이순신', '010-1234-1008', '서울시 영동포구', '2022-01-08'),
	('c109', '송상현', '010-1234-1008', '부산시 동래구', '2022-01-09'),
...
-- 테이블 데이터 java1_shop.order:~12 rows (대략적) 내보내기
...
-- 테이블 데이터 java1_shop.product:~6 rows (대략적) 내보내기
...
INSERT INTO `orders` (`orderNo`, `userId`, `orderTotalPrice`, `orderAddr`, `orderStatus`, `orderDate`) VALUES
	...
	('22010510031', 'user10', 782000, '대전시 한밭로 24-1', 2, '2022-01-10 10:50:12'),
...
INSERT INTO `users` (`userId`, `userName`, `userBirth`, `userGender`, `userHp`, `userEmail`, `userPoint`, `userLevel`, `userAddr`, `userRegDate`) VALUES
	...
	('user3', '김춘수', '1989-05-30', 'M', '010-1103-1989', NULL, 1200, 2, '서울', '2022-01-10 10:50:12'),
	('user4', '이사부', '1979-04-13', 'M', '010-2101-1979', 'leesabu@naver.com@', 2600, 1, '서울', '2022-01-10 10:50:12'),
	...
	('user7', '강감찬', '1984-06-15', 'F', '010-4101-1984', 'kang@naver.com@', 800, 0, '대구', '2022-01-10 10:50:12'),
	('user8', '신사임당', '1965-10-21', 'M', '010-5101-1965', 'sinsa@naver.com@', 1500, 1, '대구', '2022-01-10 10:50:12'),
	('user9', '이이', '1972-11-28', 'F', '010-6101-1972', 'leelee@naver.com@', 3400, 3, '부산', '2022-01-10 10:50:12');
...
-- 테이블 데이터 java1_university.lectures:~9 rows (대략적) 내보내기
...
INSERT INTO `professors` (`proNo`, `depNo`, `proName`, `proJumin`, `proHp`, `proEmail`, `proAddr`) VALUES
	('P10101', 10, '김유신', '750120-1234567', '010-1101-1976', 'kimy9@hg.ac.kr', '서울'),
...
INSERT INTO `register` (`stdNo`, `lecNo`, `proNo`, `regAttenScore`, `regMidScore`, `regFinalScore`, `regEtcScore`, `regTotal`, `regGrade`) VALUES
	...
	('20111014', '111012', 'P11104', NULL, NULL, NULL, NULL, NULL, NULL),
...
INSERT INTO `member` (`uid`, `name`, `hp`, `pos`, `dep`, `rdate`) VALUES
	('a101', '박혁거세', '010-1234-1001', '부장', 101, '2022-08-24 11:58:35'),
	('a102', '김유신', '010-1234-1002', '차장', 101, '2022-08-24 12:01:54'),
	('a103', '김춘추', '010-1234-1003', '사원', 101, '2022-08-24 12:01:54'),
	('a104', '장보고', '010-1234-1004', '대리', 102, '2022-08-24 12:01:54'),
	('a105', '강감찬', '010-1234-1005', '과장', 102, '2022-08-24 12:01:54'),
	('a106', '이성계', '010-1234-1006', '차장', 103, '2022-08-24 12:01:54'),
	('a107', '정철', '010-1234-1007', '차장', 103, '2022-08-24 12:01:54'),
	('a108', '이순신', '010-1234-1008', '부장', 104, '2022-08-24 12:01:54'),
	('a109', '허균', '010-1234-1009', '부장', 104, '2022-08-24 12:01:54'),
	('a110', '정약용', '010-1234-1010', '사원', 105, '2022-08-24 12:01:54'),
	('a111', '박지원', '010-1234-1011', '사원', 105, '2022-08-24 12:01:54'),
	('b101', '을사문적', '010-5555-1234', '사장', 107, '2022-08-25 11:09:45'),
	('x101', '길은섭', '010-8888-9999', '대장', 101, '2022-10-12 13:00:01');
...
-- 테이블 데이터 java1db.tbluser:~5 rows (대략적) 내보내기
...
-- 테이블 데이터 java1db.user1:~6 rows (대략적) 내보내기
INSERT INTO `user1` (`uid`, `name`, `hp`, `age`) VALUES
	('x102', '라인하르트', '010-5255-2225', 101),
	('x103', '양나리', '010-6666-4444', 55),
	('qwer', '아나', '010-1234-5678', 66),
	('ㅁㄴㅇㄹ', '모이라', '010-8888-1111', 30),
	('G999', '겐지', '010-7777-5555', 99);
...
-- 테이블 데이터 java1db.user2:~2 rows (대략적) 내보내기
...
INSERT INTO `user3` (`uid`, `name`, `hp`, `age`) VALUES
	('z001', '유저3', '010-1234-8989', 55),
	('z101', '양나리', '010-1112-2223', 28);
...
-- 테이블 데이터 java1db.user4:~2 rows (대략적) 내보내기
...
-- 테이블 데이터 java1db.user5:~2 rows (대략적) 내보내기
INSERT INTO `user5` (`uid`, `name`, `birth`, `gender`, `age`, `address`, `hp`) VALUES
	(NULL, '김유신', '0000-00-00', NULL, 1, NULL, NULL),
	(NULL, '김춘추', '0000-00-00', NULL, 1, '부산시', NULL);
...
-- 테이블 데이터 java1db.user6:~2 rows (대략적) 내보내기
INSERT INTO `user6` (`uid`, `name`, `birth`, `gender`, `age`, `address`, `hp`) VALUES
	(NULL, '김유신', '0000-00-00', NULL, 1, NULL, NULL),
	(NULL, '김춘추', '0000-00-00', NULL, 1, '부산시', NULL);
